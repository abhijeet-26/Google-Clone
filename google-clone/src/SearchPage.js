                ...
                <div className="searchPage__headerBody">
                    ...
                    <div className="searchPage__options">
                        <div className="searchPage_optionsLeft">
                            ...
                            <div className="searchPage_option">
                                <LocalOfferIcon />
                                <Link to="/shooping">Shopping</Link>
                            </div>
                            <div className="searchPage_option">
                                <RoomIcon />
                ...
                <div className="searchPage__results">
                    <p className="searchPage__resultCount">
                        About {data?.searchInformation.
                            formattedTotalResults} results ({data?.searchInformation.formattedSearchTime} seconds)
                             for {term}
                    </p>
                    ...
                    {data?.items.map(item => (
                        <div className="searchPage__result">
                                ...
                                <a
                                    ...
                                    {item.pagemap?.cse_image?.length > 0 &&
                                        item.pagemap?.cse_image[0]?.src && (
                                            <img
                                                className="searchPage_reslutImage"
                                                src={
                                                    item.pagemap?.cse_image?.length > 0 &&
                                                    item.pagemap?.cse_image[0]?.src
                                                }
                            ...
                            <a className="searchPage__resultTittle"
                                href={item.link}>
                                <h3>{item.title}</h3>
                            </a>
